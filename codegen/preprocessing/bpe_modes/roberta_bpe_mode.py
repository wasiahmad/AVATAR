...
from codegen.preprocessing.bpe_modes.bpe_mode import BPEMode
from codegen.preprocessing.obfuscation.utils_deobfuscation import (
    OBFUSCATED_PREFIXES,
)
...
class RobertaBPEMode(BPEMode):
    ...
    def __init__(self) -> None:
        vocab_path = str(
            Path(__file__).parents[3].joinpath("codegen/bpe/roberta-base-vocab")
        )
        logger.info(
