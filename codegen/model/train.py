...
from codegen.model.src.data.loader import check_data_params, load_data
from codegen.model.src.evaluation.evaluator import SingleEvaluator, EncDecEvaluator
from codegen.model.src.model import check_model_params, build_model, build_classifier
from codegen.model.src.slurm import init_signal_handler, init_distributed_mode
from codegen.model.src.trainer import SingleTrainer, EncDecTrainer
from codegen.model.src.utils import bool_flag, initialize_exp, set_sampling_probs, shuf_order
from codegen.model.src.utils import print_memory
...
def main(params):
    ...
    for _ in range(params.max_epoch):
        ...
        # evaluate perplexity
        if params.eval_bleu_valid_only:
            scores = evaluator.run_all_evals(trainer, ['valid'])
        else:
            scores = evaluator.run_all_evals(trainer)
