...
class TranslationMultiSimpleEpochTaskExtended(TranslationMultiSimpleEpochTask):
    ...
    def build_generator(
            ...
            if tgt_langtok_spec:
                if self.training:
                    ...
                    for lang_pair in self.eval_lang_pairs:
                        ...
                        tgt_lang_toks.append(self.data_manager.get_decoder_langtok(tgt_lang, tgt_langtok_spec))
                    extra_gen_cls_kwargs = extra_gen_cls_kwargs or {}
                    print(tgt_lang_toks)
                    extra_gen_cls_kwargs["symbols_to_strip_from_output"] = set(tgt_lang_toks)
                else:
        ...
        return super(TranslationMultiSimpleEpochTask, self).build_generator(
